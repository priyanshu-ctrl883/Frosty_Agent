...
import { signOut, waitForSession } from "@/lib/session";
...
/**
 * Company-name capture step for users who authenticated via Google OAuth.
 */
function GoogleCompanyForm() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    if (!acceptedLegal) {
      setError("Accept the Privacy notice and Terms to create a workspace.");
      return;
    }
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-white text-slate-800">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-semibold text-slate-500">Setting up your workspace...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen w-full bg-white text-slate-900 font-sans selection:bg-[#0092A2]/20 flex flex-col justify-between relative overflow-x-hidden">
      ...
      <div className="w-full max-w-[1340px] mx-auto px-5 sm:px-8 lg:px-10 py-6 sm:py-8 flex-1 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 relative z-10 my-auto">
          ...
          <div className="mt-8 relative pt-3 pb-2 max-w-lg">
            ...
            >
              ...
              <motion.path
                ...
                strokeLinecap="round"
                opacity="0.9"
                markerEnd="url(#google-sketch-arrow)"
        ...
        {/* ── RIGHT COLUMN: Elevated White Company Setup Card ── */}
          ...
          <div className="w-full max-w-[420px] bg-white rounded-[32px] p-8 sm:p-10 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.07),0_8px_30px_-6px_rgba(0,146,162,0.05)] border border-slate-100/90 transition-all duration-300">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-slate-500 mt-1 font-medium">
                One last step to start using your AI workspace
              </p>
            </div>
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              {!SUPABASE_CONFIGURED && (
                <p className="text-[11px] text-amber-700 bg-amber-50 border border-amber-200 rounded-md p-2">
                  Sign-up is not configured for this build.
                </p>
              )}
              ...
              <button
                type="submit"
                disabled={loading || !SUPABASE_CONFIGURED || !acceptedLegal}
              ...
              >
                <span>{loading ? "Creating Workspace..." : "Create Workspace & Continue"}</span>
            ...
            <div className="mt-5 text-center text-xs text-slate-500 font-medium">
              ...
              <button
                type="button"
                className="text-[#0092A2] font-bold hover:underline bg-transparent border-0 p-0 cursor-pointer"
                onClick={() => {
