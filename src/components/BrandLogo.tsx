...
export default function BrandLogo({
  ...
  useGSAP(
    () => {
      ...
      const onEnter = () => {
        gsap.to(".brand-logo-inner", { scale: 1.03, duration: 0.35, ease: "power2.out" });
      };
      const onLeave = () => {
        gsap.to(".brand-logo-inner", { scale: 1, duration: 0.5, ease: "elastic.out(1, 0.5)" });
      };
  ...
  return (
    <div ref={containerRef} className="group flex cursor-pointer select-none items-center">
